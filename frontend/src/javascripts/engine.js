...
CanvasRenderer = class CanvasRenderer {
    ...
    renderMeteor(meteor) {
        ...
        if (meteor.is_raw) {
            gradient1.addColorStop(0, 'hsla(295, 60%, 50%, .25)');
            gradient1.addColorStop(1, 'hsla(295, 60%, 50%, 0)');
        } else {
    ...
    renderMeteorBorder(meteor) {
        ...
        if (meteor.is_raw) {
            gradient2.addColorStop(0, 'hsla(295, 100%, 50%, 0)');
            gradient2.addColorStop(.1, 'hsla(295, 100%, 100%, .75)');
            gradient2.addColorStop(1, 'hsla(295, 100%, 50%, 0)');
        } else {
    ...
    renderMeteorFlare(meteor) {
        ...
        if (meteor.is_raw) {
            gradient3.addColorStop(0, 'hsla(' + (295 + 30) % 360 + ', 100%, 50%, .2)');
            gradient3.addColorStop(1, 'hsla(' + (295 + 30) % 360 + ', 50%, 50%, 0)');
        } else {
    ...
    renderMeteorFlare2(meteor) {
        ...
        if (meteor.is_raw) {
            gradient4.addColorStop(0, 'hsla(' + (295 + 60) % 360 + ', 80%, 70%, .1)');
            gradient4.addColorStop(1, 'hsla(' + (295 + 60) % 360 + ', 80%, 50%, 0)');
        } else {
